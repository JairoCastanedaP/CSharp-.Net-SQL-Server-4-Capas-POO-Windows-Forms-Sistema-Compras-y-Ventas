...
namespace Sistema.Presentacion2
{
    public partial class FrmUsuario : Form
    {
        ...
        private void BtnInsertar_Click(object sender, EventArgs e)
        {
            ...
            {
                string Rpta = "";
                if (CboRol.Text==string.Empty|| TxtNombre.Text==string.Empty || TxtEmail.Text==string.Empty || TxtClave.Text==string.Empty || TxtNombre.Text == string.Empty)
                {
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            ...
            {
                string Rpta = "";
                if (TxtId.Text==string.Empty||CboRol.Text == string.Empty || TxtEmail.Text == string.Empty ||  TxtNombre.Text == string.Empty)
                {
                    this.MensajeError("Falta ingresar algunos datos,serán remarcados");
                    ErrorIcono.SetError(CboRol, "Seleccione un rol");
                    ErrorIcono.SetError(TxtNombre, "Ingrese un nombre");
