...
namespace Sistema.Presentacion2
{
    public partial class FrmCliente : Form
    {
        ...
        {
            DgvListado.Columns[0].Visible = false;//seleccionar registro
        ...
        private void DgvListado_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                TxtTelefono.Text= Convert.ToString(DgvListado.CurrentRow.Cells["Email"].Value);

                TabGeneral.SelectedIndex = 1;
            }
            catch(Exception ex)
            {
                MessageBox.Show("Selecciones desde la celda nombre."+"|Error:"+ex.Message);
            }
        }
