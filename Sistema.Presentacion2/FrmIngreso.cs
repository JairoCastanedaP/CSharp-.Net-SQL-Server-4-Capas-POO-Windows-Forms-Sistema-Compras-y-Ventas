...
namespace Sistema.Presentacion2
{
    ...
    public partial class FrmIngreso : Form
    {
        ...
        private void TxtCodigo_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode==Keys.Enter)
                {
                    ...
                    {
                        this.MensajeError("No existe articulo con este codigo");
                    }
                    else
                    {
                        //agregar detalle
        ...
        private void BtnInsertar_Click(object sender, EventArgs e)
        {
            ...
            {
                string Rpta = "";
                if (TxtIdProveedor.Text == string.Empty || TxtImpuesto.Text.Trim()==string.Empty || TxtNumComprobante.Text.Trim()==string.Empty || DtDetalle.Rows.Count==0)
                {
                ...
                {
                    Rpta = NIngreso.Insertar(Convert.ToInt32(TxtIdProveedor.Text.Trim()), Variables.IdUsuario,CboComprobante.Text,TxtSerieComprobante.Text.Trim(),TxtNumComprobante.Text.Trim(),Convert.ToDecimal(TxtImpuesto.Text),Convert.ToDecimal(TxtTotal.Text),DtDetalle);
                    if (Rpta.Equals("OK"))
                    {
        ...
        private void TxtSubtotalD_TextChanged(object sender, EventArgs e)
        {
